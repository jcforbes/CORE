...
set xlabel 'M/M_{sun}'
set ylabel 'dn/dlogM'
set label "0.5" at graph 0.3, graph 0.77 tc rgb '#999999'
set label "0.83" at graph 0.3, graph 0.68 tc rgb '#777777'
set label "1.0" at graph 0.3, graph 0.63 tc rgb '#000000'
set label "1.17" at graph 0.3, graph 0.56 tc rgb '#666666'
set label "1.5" at graph 0.3, graph 0.5 tc rgb '#444444'
set label "2.0" at graph 0.3, graph 0.41 tc rgb '#222222'
#setdata
data =  '../data/v2013-03-03-23-15-distr_r.txt'
data1 = '../data/v2013-03-03-23-35-distr_r.txt'
data2 = '../data/v2013-03-03-23-55-distr_r.txt'
data3 = '../data/v2013-03-04-00-15-distr_r.txt'
data4 = '../data/v2013-03-04-00-35-distr_r.txt'
data5 = '../data/v2013-03-04-00-55-distr_r.txt'
data6 = '../data/v2013-03-04-01-15-distr_r.txt'
data7 = '../data/v2013-03-04-01-35-distr_r.txt'
data8 = '../data/v2013-03-04-01-55-distr_r.txt'
data9 = '../data/v2013-03-04-02-15-distr_r.txt'
obs = '../data/R09_kde.txt'
Kdist = '../data/Kroupa.txt'
olt = 2 
plot data u 1:($1*$2/$13) w p pt 1 ps 0.5 lc 1 notitle,\
data u 1:($1*$2/$13) w l lt 1 lc 1 title 'initial condition',\
...
data4 u 1:($1*$12/$13) w p pt 7 ps 0.5 lc rgb '#666666' notitle,\
data4 u 1:($1*$12/$13) w l lt olt lc rgb '#666666' notitle,\
data6 u 1:($1*$12/$13) w p pt 7 ps 0.5 lc rgb '#444444' notitle,\
data6 u 1:($1*$12/$13) w l lt olt lc rgb '#444444' notitle,\
data9 u 1:($1*$12/$13) w p pt 7 ps 0.5 lc rgb '#222222' notitle,\
data9 u 1:($1*$12/$13) w l lt olt lc rgb '#222222' notitle,\
data3 u 1:($1*$12/$13) w l lt 1 lw 4 lc rgb '#000000' title 'standard result',\
